...
color_key = {"dimgray": "gray", "darkgray": "gray", "gray": "gray", "darkslategray": "gray", "slategray": "gray", "whitesmoke": "gray","silver": "gray", "linen": "gray"}
...
def convert_rgb_to_names(rgb_tuple):
     ...
     if(names[index] in color_key.keys()):
